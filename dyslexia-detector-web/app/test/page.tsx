...
export default function TestPage() {
    ...
    // The rest of the component state and logic remain the same
    ...
    const handleGameComplete = (result: GameResult) => {
        ...
        recordGameResult(result.gameType, 'completed', result);
    ...
    // The rest of the JSX is identical since the state and props logic are the same.
    // ... [welcome, game-select, playing, and results phases]
